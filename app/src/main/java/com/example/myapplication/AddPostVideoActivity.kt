...
class AddPostVideoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pollquestion = findViewById(R.id.Video_poll_question)
        contestantone = findViewById(R.id.Video_contestant_one)
        contestanttwo = findViewById(R.id.Video_contestant_two)


        storagePostPicRef = FirebaseStorage.getInstance().reference.child("posts Video")
