...
class AllPostsAdapter(private var mContext: Context,
...
//        return if (mPost!!.isNotEmpty()) {
//            mPost!!.size + (mPost!!.size / ITEM_FEED_COUNT).toFloat().roundToInt()
//        } else mPost!!.size
//    }
...
/*                val intent = Intent(Intent.ACTION_SEND)
                ...
                intent.putExtra(Intent.EXTRA_SUBJECT, "${post.getPostid()}")
                ...
                holder.btncontestantone.setOnCheckedChangeListener(object :
                ...
                holder.btncontestanttwo.setOnCheckedChangeListener(object :
                    CompoundButton.OnCheckedChangeListener {
...
/*    fun generateSharingLink(deepLink: Uri, getShareableLink: (String) -> Unit = {} ) {
