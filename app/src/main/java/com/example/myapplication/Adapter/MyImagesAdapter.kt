...
class MyImagesAdapter(private val mContext : Context, mPost : List<AllPost>)
    : RecyclerView.Adapter<MyImagesAdapter.ViewHolder?>()

   {
       private var mPost: List<AllPost>? = null
       ...
       override fun onBindViewHolder(holder: ViewHolder, position: Int) {
           ...
           val post : AllPost = mPost!![position]
...
//           Picasso.get().load(post.getPostimage()).into(holder.postImage)
           ...
           holder.postImage.setOnClickListener {
               ...
               (mContext as FragmentActivity).supportFragmentManager
                   .beginTransaction()
                   .replace(R.id.frame, PostDetailsFragment()).commit()
           }
       }
